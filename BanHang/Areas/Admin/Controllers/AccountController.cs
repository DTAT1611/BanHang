...
namespace BanHang.Areas.Admin.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Create(ApplicationUser model)
        {
            ...
            {
                var user = new ApplicationUser { UserName = model.UserName, Email = model.Email, FullName = model.FullName, Phone = model.Phone, Role=model.Role,/*EmailConfirmed=model.EmailConfirmed=true*/ };
